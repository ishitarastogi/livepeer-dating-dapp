 ...
 const [createSetProfileMetadataTypedData, {}] = useMutation(
  ...
  const handleCreateProfile = async (e) => {
    ...
    const data = {
      ...
      // attributes: [
      //   {
      //     traitType: "Enter location",
      //     value: location,
      //     displayType: "string",
      //   },
      //   {
      //     traitType: "what's your favorite NFT character",
      //     value: nft,
      //     displayType: "string",
      //   },
      //   {
      //     traitType: "shortvideo",
      //     value: playbackId,
      //     displayType: "string",
      //   },
      //   {
      ...
      //   {
      //     traitType: "Tell us about your most memorable moments",
      //     value: moment,
      //     displayType: "string",
      //   },
      //   {
      //     traitType: "Choose date",
      //     value: date,
      //     key: "string",
      //   },
      // ],
  ...
  return (
    <div class="container">
      ...
      <div class="card">
        ...
        <form className="card-form" onSubmit={handleCreateProfile}>
          <div class="input">
            <input
              type="text"
              class="input-field"
          ...
          >
            ...
            <br />
            {/* <ul>{data && data.map((link) => <li>{link?.name}</li>)}</ul> */}
